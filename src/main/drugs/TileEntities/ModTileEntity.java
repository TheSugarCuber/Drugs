...
public class ModTileEntity extends TileEntity implements IInventory
{
	...
	public ItemStack decrStackSize(int index, int count)
	{
		if(this.getStackInSlot(index) != null)
		{
			...
			else
			{
				...
				{
					//Just to show that chages happended
	...
	public boolean isUseableByPlayer(EntityPlayer player) {
		return this.worldObj.getTileEntity(this.getPos()) == this && player.getDistanceSq(this.pos.add(0.5, 0.5, 0.5)) <= 8;
	}
	...
	public boolean isItemValidForSlot(int index, ItemStack stack) {
		//if(stack.equals(items.StartupCommon.kiloCocaine))
			return true;
		//return false;
	}
